...
//    }
    ...
    func testBrokenChords() {
        // the following should work, but doesn't because all chords are hardcoded in Tonic
        // assertRankedChord([64, 67, 70, 72], expectedDescriptions: ["C7/E", "E°(add♭13)"])
    }
